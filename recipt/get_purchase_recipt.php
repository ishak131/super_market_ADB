...
$quary = "SELECT * FROM total_price_recipt WHERE r_Type = 'purchase'";
...
<body>
    ...
    <div class="row">
        <?php foreach ($resultAll as $recipt) : ?>
            <div class='column'>
                <div class='card'>
                    <a style="color: black; text-decoration: none;" href="./get_one_purchase_recipt.php?id=<?php echo $recipt['_id'] ?>">
